...
public class PersonTest extends TestCase {
    ...
    public void testSpace() throws PersonParseException {
    	...
    	String[] elements = { PersonParser.LAST_NAME, PersonParser.FIRST_NAME, PersonParser.IGNORE,
				PersonParser.GENDER, PersonParser.DATE_OF_BIRTH, PersonParser.COLOR };
		String delimiter = "\\s+";
    ...
    public void testPipe() throws PersonParseException {
		...
		String[] elements = { PersonParser.LAST_NAME, PersonParser.FIRST_NAME, PersonParser.IGNORE,
    			PersonParser.GENDER, PersonParser.COLOR, PersonParser.DATE_OF_BIRTH };
    ...
    public void testComma() throws PersonParseException {
		...
		String[] elements = { PersonParser.LAST_NAME, PersonParser.FIRST_NAME, PersonParser.GENDER,
    			PersonParser.COLOR, PersonParser.DATE_OF_BIRTH };
        String delimiter = "\\s*,\\s*";
